...
\begin{frame}{Eduroam}
    \begin{minipage}[t]{0.515\textwidth}
        ...
        \only<1>{
            \begin{center}
                \vspace{-7.5em}
                \includegraphics[width=1.8\textwidth]{eduroam_map.png}
            \end{center}
        }
    \end{minipage}
...
\begin{frame}{Moodle -- uniweite E-Learningplattform}
    \only<1>{%}
        \begin{figure}
            \centering
            \includegraphics[scale=0.25]{images/moodle06.jpg}
        \end{figure}
    }
    \only<2>{%}
        \begin{figure}
    ...
    \only<3>{%}
        \begin{figure}
            \centering
            \includegraphics[scale=0.25]{images/moodle08.jpg}
        \end{figure}
    }
    \only<4>{%}
        \begin{figure}
    ...
    \only<5>{%}
        \begin{figure}
            \centering
            \includegraphics[scale=0.25]{images/moodle10.jpg}
        \end{figure}
    }
    \only<6>{%}
    ...
    \only<7>{%}
    \glqq Profil bearbeiten\grqq \ anklicken
        \begin{figure}
            \centering
            \includegraphics[scale=0.3]{images/moodle15.jpg}
        \end{figure}
    }
    \only<8>{%}
    ...
    \only<9>{%}
    E-Mail-Benachrichtigung über Forumsbeiträge einstellen:\\
    \glqq Einstellungen\grqq \ anklicken
        \begin{figure}
            \centering
            \includegraphics[scale=0.3]{images/moodle11.jpg}
        \end{figure}
    }
    \only<10>{%}
